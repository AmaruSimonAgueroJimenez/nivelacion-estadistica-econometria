...
| Regresión múltiple | *Ceteris paribus*, dummies, logaritmos | `lm(y ~ x1 + x2)` |
...
Cada celda: **coeficiente** arriba y **(error estándar)** debajo; las estrellas codifican el valor-$p$: `+` $p<0.1$, `*` $p<0.05$, `**` $p<0.01$, `***` $p<0.001$. El modelo (2) agrega experiencia y antigüedad como controles.
